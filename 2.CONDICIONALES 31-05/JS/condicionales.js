...
if (d > 0) {
  console.log(d + ' es positivo');
}
if (d < 0) {
  console.log(d + ' es negativo');
  
}
if (d === 0) {
  console.log(d + ' es cero');
}
...
const getHalf = (numberA, numberB, numberC) => {
  ...
  if (getHalf >= 0 && getHalf < 5) {
    console.log(getHalf + ' suspenso');
    return;
  }
  if (getHalf >= 5 && getHalf < 8) {
    console.log(getHalf + ' has aprobado');
  }
  if (getHalf >= 8) {
    console.log(getHalf + ' Matricula de honor');
  }
};
getHalf(8, 7, 8);
...
const sumNumbers = (numberD, numberE)=>{
    if(typeof numberD === 'string'){
        numberD = Number( numberD)
    }if(typeof numberE === 'string'){
        numberE = Number(numberE)
    }
